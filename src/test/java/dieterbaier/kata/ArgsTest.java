...
public class ArgsTest {
  ...
  @Test
  public void argumentsAsOneString() {
    argumentParser.parse("-d /any/Path -p 8080 -l");
  ...
  @Test
  public void argumentsAsOneStringAndDirectoryFlagsArgumentWithBlank() {
    argumentParser.parse("-d \"/any/Path inDirectory\" -p 8080 -l");
  ...
  @Test
  public void morePorts() {
    argumentParser.parse(new String[] { "-l", "-p", "8080,4711", "-d", "/any/path" });
    final String[] allValues = argumentParser.getAllValues('p');
    assertThat(allValues.length, is(2));
    assertThat(allValues[0], is("8080"));
    assertThat(allValues[1], is("4711"));
  }
